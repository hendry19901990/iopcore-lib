# IoP Address
Represents a IoP address. Addresses are the most popular way to make IoP transactions. See [the official Bitcoin Wiki](https://en.bitcoin.it/wiki/Address) for technical background information.
...
```javascript
// from a string
var address = Address.fromString('uKfPkxBmxfHMK8MScBtbdTGbXoqvNzCDbL');
